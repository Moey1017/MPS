...
export default class StoreVehicle extends React.Component<any, any>
{
            ...
            toReturn.push(
                <Reactstrap.Modal.Dialog key="1" className="cus-margin-modal-store">
                    ...
                    <Reactstrap.Modal.Footer>
                        <Link className="btn btn-success" onClick={this.handleCloseModal} to='/'>Continue</Link>
                    </Reactstrap.Modal.Footer>
        ...
        return (
            ...
            <div className="container mh-100 b-banner-image">
                ...
                <div className="overflow-auto terms-container">
                    <h1 className="display-5 cus-terms-title">Terms and Conditions</h1>
                ...
                <div className="row cus-margin-home">
                    <input type="checkbox" onChange={this.handleChecked} className="d-block cus-checkbox">
                    </input>
                    <label className="cus-terms-label">Please tick to accept the terms and conditions</label>
